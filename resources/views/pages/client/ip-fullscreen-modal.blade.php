            ...
            <div class="modal-dialog momodel modal-fluid" role="document">
                <div class="modal-content ">
                    <div class=" modal-header">
                        ...
                        <h3 v-show="editMode"  class="modal-title w-100" id="exampleModalPreviewLabel"><i class="ti-marker-alt m-r-10"></i>Edit IP</h3>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr v-for="ip in ips" :key="ip.id">
                                                    <td>@{{ip.id}}</td>
                                                    <td>@{{ip.ip}}</td>
                                                    <td><button v-on:click="editIP(ip.id)" class="btn btn-sm btn-success"><i class="fa fa-edit"></i></button></td>
