                ...
                <div class="modal-content ">
                    <form @submit.prevent="editMode ? update():save()" class="m-t-30">
                        <div class=" modal-header">
                            <h3 v-show="!editMode" class="modal-title w-100" id="exampleModalPreviewLabel"><i class="ti-marker-alt m-r-10"></i>Add New Gateway</h3>
                            <h3  v-show="editMode" class="modal-title w-100" id="exampleModalPreviewLabel"><i class="ti-marker-alt m-r-10"></i>Edit Gateway</h3>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input v-model="form.name"  type="text" name="name" :class="{ 'is-invalid': form.errors.has('name') }" class="form-control">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input v-model="form.ip"  type="text" name="ip" :class="{ 'is-invalid': form.errors.has('ip') }" class="form-control">
                                                <has-error :form="form" field="ip"></has-error>
                                            </div>
                                            <div class="form-group">
                                                <label for="">Port</label>
                                                <input v-model="form.port"  type="text" name="port" :class="{ 'is-invalid': form.errors.has('port') }" class="form-control">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input v-model="form.call_limit"  type="number" name="call_limit" :class="{ 'is-invalid': form.errors.has('call_limit') }" class="form-control">
                                            ...
                                            <div class="custom-control custom-radio">
                                                <input v-model="form.media_proxy" type="radio" id="yes" name="media_proxy" class="custom-control-input" value=1>
                                                <label class="custom-control-label" for="yes">Yes</label>
                                            </div>
                                            <div class="custom-control custom-radio m-b-20">
                                                <input v-model="form.media_proxy" type="radio" id="no" name="media_proxy" class="custom-control-input" value=0>
