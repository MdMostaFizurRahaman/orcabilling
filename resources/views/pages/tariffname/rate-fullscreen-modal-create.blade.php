<div class="scoped">
        <!-- Modal -->
        <div class="modal  animated slideInRight right" id="rate-fullscreen-modal-create" tabindex="-1" role="dialog" aria-labelledby="exampleModalPreviewLabel" aria-hidden="true">
            <div class="modal-dialog modal-fluid" role="document">
                <div class="modal-content ">
                    <form @submit.prevent="save()" class="m-t-30">
                        <div class=" modal-header">
                            <h3 class="modal-title w-100" id="exampleModalPreviewLabel"><i class="ti-marker-alt m-r-10"></i>Add New Rate</h3>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    ...
                                    <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <label for="">From Day (Start from Sunday)</label>
